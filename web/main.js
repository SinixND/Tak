...
// include: /data/data/com.termux/files/usr/tmp/tmpz7pk52nr.js
  ...
  (() => {
    ...
    async function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = 'bin/web/release/main.data';
...
Module['FS_createPath']("/", "data", true, true);
      ...
      async function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          Module['removeRunDependency']('datafile_bin/web/release/main.data');
      }
      Module['addRunDependency']('datafile_bin/web/release/main.data');
    ...
    loadPackage({"files": [{"filename": "/data/empty", "start": 0, "end": 0}], "remote_package_size": 0});

  })();

// end include: /data/data/com.termux/files/usr/tmp/tmpz7pk52nr.js
// include: /data/data/com.termux/files/usr/tmp/tmp41afsqqg.js

    // All the pre-js content up to here must remain later on, we need to run
    // it.
    if ((typeof ENVIRONMENT_IS_WASM_WORKER != 'undefined' && ENVIRONMENT_IS_WASM_WORKER) || (typeof ENVIRONMENT_IS_PTHREAD != 'undefined' && ENVIRONMENT_IS_PTHREAD) || (typeof ENVIRONMENT_IS_AUDIO_WORKLET != 'undefined' && ENVIRONMENT_IS_AUDIO_WORKLET)) Module['preRun'] = [];
    var necessaryPreJSTasks = Module['preRun'].slice();
  // end include: /data/data/com.termux/files/usr/tmp/tmp41afsqqg.js
// include: /data/data/com.termux/files/usr/tmp/tmpcq0r7_n7.js

    if (!Module['preRun']) throw 'Module.preRun should exist because file support used it; did a pre-js delete it?';
    necessaryPreJSTasks.forEach((task) => {
      if (Module['preRun'].indexOf(task) < 0) throw 'All preRun tasks that exist before user pre-js code should remain after; did you replace Module or modify Module.preRun?';
    });
  // end include: /data/data/com.termux/files/usr/tmp/tmpcq0r7_n7.js
...
var ASM_CONSTS = {
  80848: () => { if (document.fullscreenElement) return 1; },  
 80894: () => { return Module.canvas.width; },  
 80926: () => { return parseInt(Module.canvas.style.width); },  
 80974: () => { document.exitFullscreen(); },  
 81001: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 81074: () => { if (document.fullscreenElement) return 1; },  
 81120: () => { return Module.canvas.width; },  
 81152: () => { return screen.width; },  
 81177: () => { document.exitFullscreen(); },  
 81204: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 81337: () => { return window.innerWidth; },  
 81363: () => { return window.innerHeight; },  
 81390: () => { if (document.fullscreenElement) return 1; },  
 81436: () => { return Module.canvas.width; },  
 81468: () => { return parseInt(Module.canvas.style.width); },  
 81516: () => { if (document.fullscreenElement) return 1; },  
 81562: () => { return Module.canvas.width; },  
 81594: () => { return screen.width; },  
 81619: () => { return window.innerWidth; },  
 81645: () => { return window.innerHeight; },  
 81672: () => { if (document.fullscreenElement) return 1; },  
 81718: () => { return Module.canvas.width; },  
 81750: () => { return screen.width; },  
 81775: () => { document.exitFullscreen(); },  
 81802: () => { if (document.fullscreenElement) return 1; },  
 81848: () => { return Module.canvas.width; },  
 81880: () => { return parseInt(Module.canvas.style.width); },  
 81928: () => { document.exitFullscreen(); },  
 81955: ($0) => { Module.canvas.style.opacity = $0; },  
 81993: () => { return screen.width; },  
 82018: () => { return screen.height; },  
 82044: () => { return window.screenX; },  
 82071: () => { return window.screenY; },  
 82098: () => { return window.devicePixelRatio; },  
 82134: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 82187: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 82238: () => { Module.canvas.style.cursor = 'none'; },  
 82275: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 82531: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 82582: () => { if (document.fullscreenElement) return 1; },  
 82628: () => { return window.innerWidth; },  
 82654: () => { return window.innerHeight; },  
 82681: () => { if (document.pointerLockElement) return 1; }
};
